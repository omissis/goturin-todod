...
_DOCKER_GOLANG_IMAGE=golang:1.22.0
_DOCKER_GOLANG_IMAGE_TOOLS=golang:1.22.0-tools
...
migrate-up:
	@migrate -source file://database/migrate -database 'postgres://todod:todod@localhost:5432/todod?sslmode=disable' up

migrate-down:
	@migrate -source file://database/migrate -database 'postgres://todod:todod@localhost:5432/todod?sslmode=disable' down
